...
launch_latency_tests() {
  ...
  git clone -b main https://github.com/seapath/svtrace-ansible
  cd svtrace-ansible
  ...
  mv ${WORK_DIR}/svtrace-ansible/tests_results/data/ci_latency_tests_yoctoCI-aaeon/results/histogram*.png ${WORK_DIR}/ci/openlab/doc/
